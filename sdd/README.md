...
| 003 | Invitaciones y ciclo de vida del vínculo | **lista para implementar**, T-019 a T-035 | Salió de partir la 001. Habilita la 004, que es donde la Fase 0 puso el riesgo real del producto. El bloqueo de escritura sobre lo archivado está medido en `spike/restrictive.py`. |
