...
| 005 | Panel de análisis | **lista para implementar**, T-036 a T-048 | Primera feature con interfaz. Cinco de las trece tareas son andamiaje que la 004 hereda. Planificarla encontró que el backend no tiene CORS. La vista del atleta queda fuera: su interruptor es una escritura y este panel se lee. |
