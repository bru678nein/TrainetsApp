...
| 001 | Identidad y aislamiento por tenant | en curso, 21 de 22 tareas | Es el agujero más grande del backend actual y lo primero que mira un revisor. Todo lo demás se construye encima. |
