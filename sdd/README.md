...
| 003 | Invitaciones y ciclo de vida del vínculo | **hecha**, 17 de 17 | El ciclo completo: invitar, aceptar, pausar, archivar y reactivar. El bloqueo de escritura sobre lo archivado vive en la base, no en los endpoints. Corrigió un defecto de la 001 que impedía al entrenador insertar en las tablas del editor. |
