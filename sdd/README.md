...
| 005 | Panel de análisis | spec escrita, **bloqueada** | Una `[NECESITA DEFINICIÓN]`: si el atleta ve su propia adherencia. El dominio y los endpoints de volumen y adherencia ya existen; falta exponer `load_progression`. Es la primera feature con interfaz. |
